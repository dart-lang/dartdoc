...
function initializeSearch(input, index) {
  ...
  input.setAttribute('placeholder', 'Search the documentation');
  ...
  input.addEventListener('keydown', event => {
    ...
    if (event.code === 'Enter' && selectedElement !== null) {
      const href = suggestionElements[selectedElement].dataset.href;
      if (href) {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (document.body.getAttribute('data-using-base-href') === 'true') {
