...
return new A.aP(a,b.l("@<0>").H(c).l("aP<1,2>"))},
...
q=r&65535
if((B.c.ae(r,16)&8191)===10)switch(q){case 438:return A.aM(a,A.ix(A.n(s)+" (Error "+q+")",e))
case 445:case 5007:p=A.n(s)
return A.aM(a,new A.bW(p+" (Error "+q+")",e))}}if(a instanceof TypeError){o=$.kc()
n=$.kd()
m=$.ke()
l=$.kf()
k=$.ki()
...
g=$.kk()
f=o.K(s)
if(f!=null)return A.aM(a,A.ix(s,f))
else{f=n.K(s)
if(f!=null){f.method="call"
return A.aM(a,A.ix(s,f))}else{f=m.K(s)
if(f==null){f=l.K(s)
if(f==null){f=k.K(s)
if(f==null){f=j.K(s)
if(f==null){f=i.K(s)
...
if(p)return A.aM(a,new A.bW(s,f==null?e:f.method))}}return A.aM(a,new A.dV(typeof s=="string"?s:""))}if(a instanceof RangeError){if(typeof s=="string"&&s.indexOf("call stack")!==-1)return new A.bZ()
s=function(b){try{return String(b)}catch(d){}return null}(a)
return A.aM(a,new A.U(!1,e,e,typeof s=="string"?s.replace(/^RangeError:\s*/,""):s))}if(typeof InternalError=="function"&&a instanceof InternalError)if(typeof s=="string"&&s==="too much recursion")return new A.bZ()
return a},
aL(a){var s
...
az(a,b,c){if(a>>>0!==a||a>=c)throw A.b(A.cy(b,a))},
m0(a,b,c){var s
...
k3(a,b){var s
if(A.jm(b))if(a instanceof A.aQ){s=A.mE(a)
...
if(r!=null)return r
return A.ma(a,s)},
ma(a,b){var s=a instanceof A.aQ?a.__proto__.__proto__.constructor:b,r=A.lD(v.typeUniverse,s.name)
b.$ccache=r
return r},
...
return r.a(a)},
f9(a){var s,r=a.x
if(!A.aA(a))if(!(a===t._))if(!(a===t.A))if(r!==7)if(!(r===6&&A.f9(a.y)))s=r===8&&A.f9(a.y)||a===t.P||a===t.T
else s=!0
else s=!0
else s=!0
else s=!0
...
if(d){s=b.x
if(!A.aA(b))if(!(b===t.P||b===t.T))if(s!==7)r=s===8&&A.cz(b.y)
else r=!0
else r=!0
else r=!0
if(r)return b
...
case 33:i.push(!0)
break
case 59:i.push(A.aI(a.u,a.e,i.pop()))
break
...
break
case 42:p=a.u
i.push(A.jE(p,A.aI(p,a.e,i.pop()),a.n))
break
case 63:p=a.u
i.push(A.iH(p,A.aI(p,a.e,i.pop()),a.n))
break
case 47:p=a.u
i.push(A.jD(p,A.aI(p,a.e,i.pop()),a.n))
break
case 40:i.push(-3)
i.push(a.p)
a.p=i.length
...
a.p=b.pop()
return s},
aI(a,b,c){if(typeof c=="string")return A.cn(a,c,a.sEA)
...
return!0},
cz(a){var s,r=a.x
if(!(a===t.P||a===t.T))if(!A.aA(a))if(r!==7)if(!(r===6&&A.cz(a.y)))s=r===8&&A.cz(a.y)
else s=!0
else s=!0
else s=!0
else s=!0
...
this.b=b
this.c=c},
jc(a,b,c){return A.mH(a,new A.aY(b.l("@<0>").H(c).l("aY<1,2>")))},
df(a,b){return new A.aY(a.l("@<0>").H(b).l("aY<1,2>"))},
...
return A.ju(s,b.subarray(c,A.b_(c,d,b.length)))},
ju(a,b){var s,r
try{s=a.decode(b)
...
kN(a){if(a instanceof A.aQ)return a.k(0)
...
return s},
jo(a,b,c){var s=A.l2(a,b,A.b_(b,c,a.length))
return s},
...
aN(a,b){return new A.U(!1,null,b,a)},
...
b_(a,b,c){if(0>a||a>c)throw A.b(A.Q(a,0,c,"start",null))
...
kP(a,b,c){var s=new A.F($.z,t.bR),r=new A.b3(s,t.E),q=new XMLHttpRequest()
B.K.cv(q,"GET",a,!0)
...
fo:function fo(){},
fp:function fp(){},
k7(a,b){var s=new A.F($.z,b.l("F<0>")),r=new A.b3(s,b.l("b3<0>"))
...
A.mO()
A.mP()},
mT(){var s,r,q,p,o,n,m,l,k=document,j=k.querySelector("body")
if(j==null)return
s=j.getAttribute("data-"+new A.aH(new A.ax(j)).T("using-base-href"))
if(s==null)return
if(s!=="true"){r=j.getAttribute("data-"+new A.aH(new A.ax(j)).T("base-href"))
if(r==null)return
q=r}else q=""
p=k.querySelector("#dartdoc-main-content")
if(p==null)return
o=p.getAttribute("data-"+new A.aH(new A.ax(p)).T("above-sidebar"))
n=k.querySelector("#dartdoc-sidebar-left-content")
if(o!=null&&o.length!==0&&n!=null)A.j8(q+A.n(o)).a8(new A.ig(n),t.P)
m=p.getAttribute("data-"+new A.aH(new A.ax(p)).T("below-sidebar"))
l=k.querySelector("#dartdoc-sidebar-right")
if(m!=null&&m.length!==0&&l!=null)A.j8(q+A.n(m)).a8(new A.ih(l),t.P)},
...
kT(a,b){if(a<0)throw A.b(A.aN("Length must be a non-negative integer: "+a,null))
...
if(a==null)return a
if(!(a instanceof A.u))return J.b2.prototype
return a},
...
a.length=0},
U(a,b){var s,r=A.je(a.length,"",!1,t.N)
...
return a.charCodeAt(b)},
by(a,b){return a+b},
a_(a,b,c,d){var s=A.b_(b,c,a.length)
...
try{p=q
return p}catch(s){if(t.r.b(A.ah(s))){if((this.c&1)!==0)throw A.b(A.aN("The error handler of Future.then must return a value of the returned future's type","onError"))
...
gcg(){return B.H}}
A.h2.prototype={
Y(a){var s,r,q,p=A.b_(0,null,a.length),o=p-0
...
A.hJ.prototype={
cb(a,b,c,d){var s,r,q,p,o=this,n=A.b_(b,c,J.aB(a))
if(b===n)return""
s=A.lS(a,b,n)
r=o.aC(s,0,n-b,!0)
q=o.b
...
return s.charCodeAt(0)==0?s:s}}
A.y.prototype={
gab(){return A.aL(this.$thrownJsError)}}
A.cH.prototype={
k(a){var s=this.a
...
$.aD.body.appendChild(q)}if("createContextualFragment" in window.Range.prototype&&!B.b.F(B.R,a.tagName)){$.ir.selectNodeContents(q)
s=$.ir
p=s.createContextualFragment(b)}else{q.innerHTML=b
p=$.aD.createDocumentFragment()
for(;s=q.firstChild,s!=null;)p.appendChild(s)}if(q!==$.aD.body)J.iY(q)
c.aY(p)
...
A.aH.prototype={
h(a,b){return this.a.a.getAttribute("data-"+this.T(A.f8(b)))},
j(a,b,c){this.a.a.setAttribute("data-"+this.T(b),c)},
...
ap(a){this.a.setAttribute("class",a.U(0," "))}}
A.i.prototype={
...
r=s.y
if(r!==-1){s=s.w[r]
q=s.getAttribute("data-"+new A.aH(new A.ax(s)).T("href"))
...
$S:1}
A.fn.prototype={}
A.fM.prototype={};(function aliases(){var s=J.aX.prototype
s.bE=s.k
s=J.W.prototype
s.bG=s.k
s=A.v.prototype
...
q(J.W,[J.dv,J.b2,J.al,A.fr,A.fn,A.fM])
r(J.fy,J.C)
q(J.bf,[J.bI,J.da])
q(A.v,[A.aG,A.f,A.ao,A.aw])
q(A.aG,[A.aP,A.cs])
r(A.c3,A.aP)
r(A.c0,A.cs)
r(A.aj,A.c0)
...
r(A.aS,A.bz)
r(A.bW,A.ad)
q(A.aQ,[A.cP,A.cQ,A.dN,A.fz,A.i8,A.ia,A.h5,A.h4,A.hO,A.hg,A.ho,A.ht,A.hU,A.hV,A.fk,A.fu,A.fv,A.hb,A.fI,A.fH,A.hB,A.hC,A.hD,A.fi,A.fo,A.fp,A.il,A.im,A.ig,A.ih,A.ic,A.hY,A.hX,A.hw,A.hx,A.hy,A.hz,A.hA,A.hR,A.hS,A.hZ,A.ie,A.ib])
q(A.dN,[A.dG,A.bd])
r(A.bN,A.t)
q(A.bN,[A.aY,A.em,A.e3,A.aH])
...
q(A.U,[A.bX,A.d8])
r(A.e7,A.cq)
q(A.c,[A.m,A.d4,A.aW,A.a7,A.cg,A.ab,A.T,A.cj,A.e_,A.cN,A.aC])
q(A.m,[A.q,A.Z,A.aT,A.bo])
q(A.q,[A.k,A.i])
q(A.k,[A.cF,A.cG,A.bc,A.aO,A.d6,A.aE,A.dB,A.c_,A.dL,A.dM,A.bk,A.b1])
r(A.cW,A.V)
r(A.be,A.e6)
q(A.L,[A.cX,A.cY])
r(A.e9,A.e8)
["m"],"p":["m"],"a":[],"f":["m"],"e.E":"m"},"eF":{"e":["a9"],"l":["a9"],"p":["a9"],"a":[],"f":["a9"],"e.E":"a9"},"eL":{"e":["S"],"l":["S"],"p":["S"],"a":[],"f":["S"],"e.E":"S"},"e3":{"t":["d","d"],"w":["d","d"]},"ax":{"t":["d","d"],"w":["d","d"],"t.V":"d"},"aH":{"t":["d","d"],"w":["d","d"],"t.V":"d"},"ec":{"a6":["d"],"at":["d"],"f":["d"]},"bV":{"a4":[]},"cf":{"a4":[]},"eN":{"a4":[]},"eM":{"a4":[]},"cV":{"a6":["d"],"at":["d"],"f":["d"]},"d5":{"e":["q"],"l":["q"],"f":["q"],"e.E":"q"},"am":{"a":[]},"aq":{"a":[]},"au":{"a":[]},"dd":{"e":["am"],"l":["am"],"a":[],"f":["am"],"e.E":"am"},"ds":{"e":["aq"],"l":["aq"],"a":[],"f":["aq"],"e.E":"aq"},"dx":{"a":[]},"bi":{"i":[],"q":[],"m":[],"a":[]},"dK":{"e":["d"],"l":["d"],"a":[],"f":["d"],"e.E":"d"},"cK":{"a6":["d"],"at":["d"],"f":["d"]},"i":{"q":[],"m":[],"a":[]},"dT":{"e":["au"],"l":["au"],"a":[],"f":["au"],"e.E":"au"},"cL":{"a":[]},"cM":{"a":[],"t":["d","@"],"w":["d","@"],"t.V":"@"},"cN":{"a":[]},"aC":{"a":[]},"dt":{"a":[]},"bl":{"l":["j"],"f":["j"]}}'))
...
return{w:s("bc"),Y:s("aO"),W:s("f<@>"),h:s("q"),U:s("y"),B:s("h"),Z:s("aU"),c:s("ak<@>"),p:s("aE"),k:s("C<q>"),Q:s("C<a4>"),s:s("C<d>"),m:s("C<bl>"),O:s("C<ae>"),L:s("C<X>"),b:s("C<@>"),t:s("C<j>"),T:s("bJ"),g:s("al"),D:s("p<@>"),e:s("a"),v:s("bg"),j:s("l<@>"),a:s("w<d,@>"),G:s("ap<d,d>"),d:s("ap<X,ae>"),P:s("D"),K:s("u"),I:s("ny"),q:s("b0<P>"),F:s("iz"),n:s("bi"),l:s("aa"),N:s("d"),u:s("i"),f:s("bk"),J:s("b1"),r:s("ad"),o:s("b2"),V:s("bn<d,d>"),R:s("dY"),E:s("b3<a1>"),x:s("bo"),M:s("H"),bR:s("F<a1>"),aY:s("F<@>"),cB:s("af"),i:s("ag"),z:s("@"),y:s("@(u)"),C:s("@(u,aa)"),S:s("j"),A:s("0&*"),_:s("u*"),bc:s("ak<D>?"),cD:s("aE?"),X:s("u?"),H:s("P")}})();(function constants(){var s=hunkHelpers.makeConstList
B.m=A.aO.prototype
B.J=A.bH.prototype
B.K=A.a1.prototype
B.f=A.aE.prototype
...
B.U=new A.aS(14,{topic:2,library:2,class:2,enum:2,mixin:3,extension:3,typedef:3,function:4,method:4,accessor:4,operator:4,constant:4,property:4,constructor:4},B.Q,A.i5("aS<d,j>"))
B.V=new A.aS(0,{},B.t,A.i5("aS<d,d>"))
B.Y=A.n6("u")
