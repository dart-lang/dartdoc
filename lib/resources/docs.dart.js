...
$S:1}
A.i2.prototype={
$0(){var s="dark-theme",r="colorTheme",q="light-theme",p=this.a,o=this.b
if(p.checked===!0){o.setAttribute("class",s)
p.setAttribute("value",s)
window.localStorage.setItem(r,"true")
p.checked=!0}else{o.setAttribute("class",q)
p.setAttribute("value",q)
window.localStorage.setItem(r,"false")
p.checked=!1}},
$S:0}
A.i0.prototype={
$0(){var s="colorTheme"
if(window.localStorage.getItem(s)!=null){this.a.checked=window.localStorage.getItem(s)==="true"
this.b.$0()}},
