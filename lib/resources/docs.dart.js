...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    findMatches(index, query) {
      var allMatches, justElements, i;
      if (query === "")
        return A._setArrayType([], type$.JSArray_Map_String_dynamic);
      allMatches = A._setArrayType([], type$.JSArray_SearchMatch);
      index.forEach$1(index, new A.findMatches_closure(allMatches, query));
      B.JSArray_methods.sort$1(allMatches, new A.findMatches_closure0());
      justElements = A._setArrayType([], type$.JSArray_Map_String_dynamic);
      for (i = 0; i < allMatches.length; ++i)
        B.JSArray_methods.add$1(justElements, allMatches[i].element);
      return justElements;
    },
    initializeSearch(input, index, htmlBase) {
      ...
      t1.suggestionsInfo = A._setArrayType([], type$.JSArray_Map_String_dynamic);
    ...
    findMatches_closure: function findMatches_closure(t0, t1) {
      this.allMatches = t0;
      this.query = t1;
    },
    findMatches_closure_score: function findMatches_closure_score(t0, t1) {
      this.element = t0;
      this.allMatches = t1;
    },
  ...
  A.init_disableSearch.prototype = {
    call$0() {
      ...
      A.print("Could not activate search functionality.");
      t1 = this.searchBox;
      if (t1 != null)
  ...
  A.init_closure.prototype = {
    call$1(response) {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$self = this, index, t1, t2, $async$temp1, $async$temp2, $async$temp3;
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              ...
              index = $async$temp1.cast$1$0$ax($async$temp2._as($async$temp3.decode$2$reviver(0, $async$result, null)), type$.Map_String_dynamic);
  ...
  A.findMatches_closure.prototype = {
    call$1(element) {
      var t1, t2, $name, qualifiedName, lowerName, lowerQualifiedName, lowerQuery;
      type$.Map_String_dynamic._as(element);
      t1 = new A.findMatches_closure_score(element, this.allMatches);
      t2 = J.getInterceptor$asx(element);
      $name = A._asString(t2.$index(element, "name"));
      qualifiedName = A._asString(t2.$index(element, "qualifiedName"));
      lowerName = $name.toLowerCase();
      lowerQualifiedName = qualifiedName.toLowerCase();
      t2 = this.query;
      lowerQuery = t2.toLowerCase();
      if ($name === t2 || qualifiedName === t2 || $name === "dart:" + t2)
        t1.call$1(2000);
        ...
        if (B.JSString_methods.startsWith$1($name, t2) || B.JSString_methods.startsWith$1(qualifiedName, t2))
          t1.call$1(750);
          ...
          t1.call$1(650);
        else if (B.JSString_methods.contains$1($name, t2) || B.JSString_methods.contains$1(qualifiedName, t2))
          t1.call$1(500);
        else if (B.JSString_methods.contains$1(lowerName, lowerQuery) || B.JSString_methods.contains$1(lowerQualifiedName, t2))
          t1.call$1(400);
    },
    $signature: 40
  };
  A.findMatches_closure_score.prototype = {
    call$1(value) {
      var t1 = this.element,
        t2 = J.getInterceptor$asx(t1),
        t3 = A._asInt(t2.$index(t1, "overriddenDepth")),
        weightFactor = B.Map_h4kjl.$index(0, t2.$index(t1, "type"));
      if (weightFactor == null)
        weightFactor = 4;
      B.JSArray_methods.add$1(this.allMatches, new A.SearchMatch(t1, (value - t3 * 10) / weightFactor));
    },
    $signature: 27
  };
  A.findMatches_closure0.prototype = {
    call$2(a, b) {
      ...
      if (x === 0)
        return A._asString(J.$index$asx(a.element, "name")).length - A._asString(J.$index$asx(b.element, "name")).length;
      return x;
    },
    $signature: 28
  };
  ...
  A.initializeSearch_createSuggestion.prototype = {
    call$2(query, match) {
      var t1, suggestion, t2, t3, suggestionTitle, t4, t5, fromLib,
        _s10_ = "enclosedBy";
      type$.Map_String_dynamic._as(match);
      t1 = document;
      suggestion = t1.createElement("div");
      t2 = J.getInterceptor$asx(match);
      suggestion.setAttribute("data-href", A._asString(t2.$index(match, "href")));
      t3 = J.getInterceptor$x(suggestion);
      t3.get$classes(suggestion).add$1(0, "tt-suggestion");
      suggestionTitle = t1.createElement("span");
      t4 = J.getInterceptor$x(suggestionTitle);
      t4.get$classes(suggestionTitle).add$1(0, "tt-suggestion-title");
      t5 = this.highlight;
      t4.set$innerHtml(suggestionTitle, t5.call$2(A.S(t2.$index(match, "name")) + " " + A._asString(t2.$index(match, "type")).toLowerCase(), query));
      suggestion.appendChild(suggestionTitle);
      if (t2.$index(match, _s10_) != null) {
        fromLib = t1.createElement("div");
        t1 = J.getInterceptor$x(fromLib);
        t1.get$classes(fromLib).add$1(0, "search-from-lib");
        t1.set$innerHtml(fromLib, "from " + A.S(t5.call$2(A._asString(J.$index$asx(type$.Map_dynamic_dynamic._as(t2.$index(match, _s10_)), "name")), query)));
        suggestion.appendChild(fromLib);
      }
      t3.addEventListener$2(suggestion, "mousedown", new A.initializeSearch_createSuggestion_closure());
      t3.addEventListener$2(suggestion, "click", new A.initializeSearch_createSuggestion_closure0(match, this.htmlBase));
      return suggestion;
    },
    $signature: 31
  };
  ...
  A.initializeSearch_createSuggestion_closure0.prototype = {
    call$1($event) {
      var t1, t2, t3, _s4_ = "href";
      type$.Event._as($event);
      t1 = this.match;
      t2 = J.getInterceptor$asx(t1);
      if (t2.$index(t1, _s4_) != null) {
        t3 = this.htmlBase;
        A.print("baseHref: " + t3);
        A.print("match.href: " + A.S(t2.$index(t1, _s4_)));
        A.print("assign: " + t3 + A.S(t2.$index(t1, _s4_)));
        B.Location_methods.assign$1(type$.Location._as(window.location), t3 + A.S(t2.$index(t1, _s4_)));
  ...
  A.initializeSearch_updateSuggestions.prototype = {
    call$2(query, suggestions) {
      var t1, t2, t3, i, t4, element, _this = this;
      type$.List_Map_String_dynamic._as(suggestions);
      t1 = _this._box_0;
      t1.suggestionsInfo = A._setArrayType([], type$.JSArray_Map_String_dynamic);
      t1.suggestionElements = A._setArrayType([], type$.JSArray_Element);
      ...
      for (t3 = _this.createSuggestion, i = 0; t4 = suggestions.length, i < t4; ++i) {
        element = t3.call$2(query, suggestions[i]);
      ...
      _this.setHint.call$1(query + B.JSString_methods.substring$1(A._asString(J.$index$asx(suggestions[0], "name")), query.length));
      t1.selectedElement = null;
  ...
  A.initializeSearch_handle.prototype = {
    call$2(newValue, forceUpdate) {
      ...
      if (newValue == null || newValue.length === 0) {
        _this.updateSuggestions.call$2("", A._setArrayType([], type$.JSArray_Map_String_dynamic));
        return;
      }
  ...
  (function installTearOffs() {
    ...
    _static_2(J, "_interceptors_JSArray__compareAny$closure", "JSArray__compareAny", 36);
    ...
    _static_1(A, "js___convertToJS$closure", "_convertToJS", 39);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "Null(Event)", "~(String,@)", "@(@)", "~(@)", "~(~())", "bool(Element,String,String,_Html5NodeValidator)", "Null(@)", "Null()", "bool(NodeValidator)", "bool(String)", "~(Symbol0,@)", "_Future<@>(@)", "~(Object?,Object?)", "@(String)", "bool(Node)", "~(String,String)", "@(@,String)", "Null(~())", "String(String)", "~(Node,Node?)", "bool(Set<String>)", "JsFunction(@)", "JsArray<@>(@)", "JsObject(@)", "Future<Null>(@)", "Object?(@)", "~(int)", "int(SearchMatch,SearchMatch)", "Null(@,StackTrace)", "String(String,String)", "Element(String,Map<String,@>)", "~(String?)", "~(String,List<Map<String,@>>)", "~(String?[bool])", "~(Event)", "int(@,@)", "~(int,@)", "Null(Object,StackTrace)", "Object?(Object?)", "~(Map<String,@>)"],
