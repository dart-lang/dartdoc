...
class GeneratorFrontEnd implements Generator, FileWriter {
  ...
  Future generate(PackageGraph packageGraph, String outputDirectoryPath) async {
    ...
    Iterable<Categorization> categories = indexElements
  ...
  void _generateDocs(
    ...
    _generatorBackend.generatePackage(this, packageGraph, packageGraph.defaultPackage);
      ...
      for (var lib in filterNonDocumented(package.libraries)) {
        ...
        for (var clazz in filterNonDocumented(lib.allClasses)) {
          ...
          for (var constructor in filterNonDocumented(clazz.constructors)) {
            ...
            _generatorBackend.generateConstructor(this, packageGraph, lib, clazz, constructor);
          }
          ...
          for (var constant in filterNonDocumented(clazz.constants)) {
            ...
            _generatorBackend.generateConstant(this, packageGraph, lib, clazz, constant);
          }
          ...
          for (var property in filterNonDocumented(clazz.staticProperties)) {
            ...
            _generatorBackend.generateProperty(this, packageGraph, lib, clazz, property);
          }
          ...
          for (var method in filterNonDocumented(clazz.allInstanceMethods)) {
            ...
            _generatorBackend.generateMethod(this, packageGraph, lib, clazz, method);
          }
          ...
          for (var operator in filterNonDocumented(clazz.allOperators)) {
            ...
            _generatorBackend.generateMethod(this, packageGraph, lib, clazz, operator);
          }
        ...
        for (var extension in filterNonDocumented(lib.extensions)) {
          ...
          _generatorBackend.generateExtension(this, packageGraph, lib, extension);

          for (var constant in filterNonDocumented(extension.constants)) {
            indexAccumulator.add(constant);
            _generatorBackend.generateConstant(this, packageGraph, lib, extension, constant);
          }

          for (var property
              in filterNonDocumented(extension.staticProperties)) {
            indexAccumulator.add(property);
            _generatorBackend.generateProperty(this,
          ...
          for (var method
            ...
            indexAccumulator.add(method);
            _generatorBackend.generateMethod(this,
        ...
        for (var mixin in filterNonDocumented(lib.mixins)) {
          ...
          for (var constructor in filterNonDocumented(mixin.constructors)) {
            ...
            indexAccumulator.add(constructor);
            _generatorBackend.generateConstructor(this,
                    packageGraph, lib, mixin, constructor);
          }

          for (var constant in filterNonDocumented(mixin.constants)) {
            if (!constant.isCanonical) continue;
            indexAccumulator.add(constant);
            _generatorBackend.generateConstant(this,
          ...
          for (var property in filterNonDocumented(mixin.staticProperties)) {
            ...
            indexAccumulator.add(property);
            _generatorBackend.generateConstant(this, packageGraph, lib, mixin, property);
          }
          ...
          for (var method in filterNonDocumented(mixin.allInstanceMethods)) {
            ...
            indexAccumulator.add(method);
            _generatorBackend.generateMethod(this, packageGraph, lib, mixin, method);
          }
          ...
          for (var operator in filterNonDocumented(mixin.allOperators)) {
            ...
            indexAccumulator.add(operator);
            _generatorBackend.generateMethod(this, packageGraph, lib, mixin, operator);
          }
        ...
        for (var eNum in filterNonDocumented(lib.enums)) {
          ...
          for (var property in filterNonDocumented(eNum.allInstanceFields)) {
            indexAccumulator.add(property);
            _generatorBackend.generateConstant(this, packageGraph, lib, eNum, property);
          }
          for (var operator in filterNonDocumented(eNum.allOperators)) {
            indexAccumulator.add(operator);
            _generatorBackend.generateMethod(this, packageGraph, lib, eNum, operator);
          }
          for (var method in filterNonDocumented(eNum.allInstanceMethods)) {
            indexAccumulator.add(method);
            _generatorBackend.generateMethod(this, packageGraph, lib, eNum, method);
          }
        }

        for (var constant in filterNonDocumented(lib.constants)) {
          indexAccumulator.add(constant);
          _generatorBackend.generateTopLevelConstant(this, packageGraph, lib, constant);
        }

        for (var property in filterNonDocumented(lib.properties)) {
          indexAccumulator.add(property);
          _generatorBackend.generateTopLevelProperty(this, packageGraph, lib, property);
        }
...
abstract class GeneratorBackend {
  ...
  void generateCategory(FileWriter writer, PackageGraph graph, Category category);
