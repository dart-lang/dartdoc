...
void main() {
  group('Source link computations', () {
    test('Basic usage', () {
      ...
      expect(sourceLinkerHref(), equals('http://github.com/base/01234abcd/to/file.dart/L14'));
    });
    ...
    test('Allow a missing revision as long as it is not in the template', () {
      ...
      expect(sourceLinkerHref(), equals('http://github.com/base/master/to/file.dart/L71'));
    });
    ...
    test('Check that paths outside exclusions work', () {
      ...
      expect(sourceLinkerHref(), equals('http://github.com/base/01234abcd/not/under/exclusion/file.dart/L14'));
    });
  });
}